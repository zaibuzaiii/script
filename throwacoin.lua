...
local function StartAddItemLoop()
    ...
    addItemLoop = task.spawn(function()
        print("🔄 Auto Add Item Started (Loop 1-3000 + Random, CD 0)")
        ...
        while autoAddItem do
            ...
            if IsTradeOpen() then
                ...
                for i = 1, 3000 do
                    ...
                    -- 70% pake loop, 30% random
                    local index
                    if math.random() < 0.3 then  -- 30% chance random
                ...
                -- Kalo udah sampe 3000 dan trade masih kebuka, ulangi
...
addItemLabel.Text = "🔄 AUTO ADD (1-3000+RANDOM)"
...
print("🔄 Auto Add Item: Loop 1-3000 + Random (CD 0, Only when trade open)")